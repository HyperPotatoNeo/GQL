...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-dir", default="/pscratch/sd/s/siddart2/checkpoints/value_baselines/qwen4b/mae/epoch_10", help="Directory containing the merged model and value head weights.")
    parser.add_argument("--dataset", default="/pscratch/sd/s/siddart2/gql_data/qwen4b/cognition.parquet", help="Parquet dataset path generated by generate_rollouts.py.")
    parser.add_argument("--batch-size", type=int, default=8, help="Batch size for evaluation.")
    parser.add_argument("--max-length", type=int, default=10000, help="Maximum sequence length for tokenization.")
    parser.add_argument("--sample-output", default="/pscratch/sd/s/siddart2/gql_evals/td_baselines/cognition.txt", help="Path to save sample predictions.")
